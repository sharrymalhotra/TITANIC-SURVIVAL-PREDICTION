# -*- coding: utf-8 -*-
"""Titanic_Survival_Prediction1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1uxakYu55WjGyQMz2nq-9ri1-xvewLgMg
...
titanic_data = pd.read_csv('/content/Titanic data.pdf.zip')
...
ngrok.set_auth_token("2WU71gO45TbeMEQSWN0lMlkcI2d_4UR7q9X7DzjozVbmd3twi")
...
<head>
    ...
    <style>
        body {
            ...
            text-align: center;
            padding: 20px;
            background-image: url('/content/Img1.jpg');
...
<body>
    ...
    <form id="predictionForm" method="post" action="/predict">
        ...
        <input type="button" value="Predict" onclick="predictSurvival()">



    <p id="predictionResult"></p>

    <img src="https://wallpaperset.com/w/full/5/f/1/484180.jpg" alt="Titanic Image">
...
def predict():
    ...
    prediction = model.predictfeature[0]
